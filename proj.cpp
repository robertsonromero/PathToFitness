...
bool fileExists(const string& fileName){
    ifstream infile(".PathToFitness/" + fileName);
    return infile.good();
}
...
void registerUser(){
    ...
    if(!(fileExists(username))){
        newFile.open(".PathToFitness/" + username);
    }
    else{
...
void myInfo(){
    ...
    string choice;
    int option;
    in.open(".PathToFitness/" + username);
    cout << endl;
    cout << "Summary " << endl;
    cout << endl;
    ...
    if(choice == "y"){
        ...
        out.open(".PathToFitness/" + username);
        out << "Age: " << age << endl;
...
void calculateDCI(){
    ...
    if(fileExists(username)){
        file.open(".PathToFitness/" + username);
    }
...
int main(){
    ...
    string ans;
    ifstream in;
    string direct = ".PathToFitness";
    CreateDirectoryRecursive(direct);
